...
Inductive kd : Set := |Send : kd | Receive : kd.
...
Definition evt_dec : forall (a b : evt) ,{a = b} + {a <> b}.
   intros a b.
   destruct a as [[[ak ao] al1] al2]; destruct b as [[[bk bo] bl1] bl2].
   destruct (kd_dec ak bk); destruct (sg_dec ao bo); 
   destruct (lf_dec al1 bl1); destruct (lf_dec al2 bl2);
